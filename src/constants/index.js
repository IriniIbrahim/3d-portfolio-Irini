...
const counterItems = [
  ...
  { value: 5, suffix: "+", label: "Real Client Projects" },
...
const expCards = [
  {
    review: "",
    imgPath: "",
    logoPath: "/images/qualified.png",
    title: "Frontend developer intern",
    date: "October 2023 - March 2024",
    responsibilities: [
      "Converting vanilla JS to react.js.",
      "Working with MIU.",
  ...
  },
  {
    ...
    responsibilities: [
      "Studying frontend fundmentals.",
      "Studying UX/UI",
      "Studying 3d and Gsap.",
      "Collabotrating in teams",
  ...
  },
  {
    ...
    responsibilities: [
      "Enhancing software from c# to asp.net.",
      "meeting clients.",
      "reporting services.",
    ],
  },
  {
    ...
    date: "2016 - 2017",
    responsibilities: [
      "Converting from asp.net to devexpress.",
